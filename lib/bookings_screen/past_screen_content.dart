...
class PastScreenContent extends StatefulWidget {
  const PastScreenContent({super.key});

  @override
  State<PastScreenContent> createState() => _PastScreenContentState();
}

class _PastScreenContentState extends State<PastScreenContent> {
  @override
          ...
          children: [
            Padding(
              ...
              child: SizedBox(
                height: height*.25,
                width: width*.7,
                child: Image.asset('images/mapcard.png'),
              ),
            ),
            Padding(
