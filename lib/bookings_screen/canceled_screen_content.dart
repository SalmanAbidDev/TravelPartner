...
class CanceledScreenContent extends StatefulWidget {
  const CanceledScreenContent({super.key});

  @override
  State<CanceledScreenContent> createState() => _CanceledScreenContentState();
}

class _CanceledScreenContentState extends State<CanceledScreenContent> {
  @override
